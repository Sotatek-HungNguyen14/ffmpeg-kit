Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/Sotatek-HungNguyen14/ffmpeg-kit'
  ...
  s.pod_target_xcconfig = { 'DEFINES_MODULE' => 'YES', 'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'i386', 'ENABLE_BITCODE' => 'NO', 'BUILD_LIBRARY_FOR_DISTRIBUTION' => 'YES' }
